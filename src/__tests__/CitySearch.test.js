...
describe('<CitySearch/> component', () => {
    ...
    test('click on suggestion should change query', () => {
    ...
    test('show suggestions disappears when text box is empty', () => {
        CitySearchWrapper.find('.city').simulate('change', { target: { value: "" } });
        expect(CitySearchWrapper.state('showSuggestion')).toBe(false)
    })
...
describe('<CitySearch/> integration', () => {
    ...
    test('get a list of cities when user searches', async () => {
